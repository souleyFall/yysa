...
function sendNewMemberEmailFull(formData) {
    ...
    .then((data) => {
        ...
        // Remplacer le contenu du formulaire par le message de succès
        const formContainer = document.querySelector('.container');
        if (formContainer) {
            formContainer.innerHTML = `
                <div class="success-message">
                    <div class="success-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#50C878" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                            <path d="m10.97 4.97-.02.022-3.473 4.425-2.093-2.094a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05"/>
                        </svg>
                    </div>
                    <h1 class="success-title">Merci pour votre adhésion ! ✨</h1>
                    <p class="success-text">Bienvenue dans la famille YYSA !</p>
                    <p class="success-description">Votre inscription a été enregistrée avec succès. Un membre de notre équipe vous contactera très bientôt pour vous accueillir et discuter de vos compétences.</p>
                    <a href="../" class="success-button">Retour au site</a>
                </div>
            `;
        }
    })
